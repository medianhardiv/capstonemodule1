...
def menampilkanDaftarBuah() :
    os.system('cls')
    print(tabulate(listBuah, headers='keys', tablefmt = 'github'))
    # print('Daftar Buah\n')
...
def menambahBuah() :
    ...
    print(colored("Buah berhasil ditambahkan!!!", 'green'))
...
def membeliBuah() :
    ...
    while True :
        ...
        if(qtyBuah > listBuah[indexBuah]['stock']) :
            print(colored('Stock tidak cukup, stock {} tinggal {}'.format(listBuah[indexBuah]['nama'],listBuah[indexBuah]['stock']), 'red'))
        else :
            cart.append({
